 ...
 */
//页面上需要的数据
var ArtWorkInfo = function (picture_url, masterName, brief, auctionStartDatetime, step, name, title, headUrl, masterId, masterWorkNum, fansNum, author) {
    ...
    this.masterWorkNum = masterWorkNum; //大师产品总数
    this.fansNum = fansNum; //大师粉丝总数
    this.author = author;
}
//项目主要信息（项目进度专用）
var ArtWorkProject = function (investEndDatetime, step, artworkInvestsSize, investStartDatetime, messageList, auctionStartDatetime, investGoalMoney, investsMoney, createDatetime) {
    ...
    this.createDatetime = createDatetime; //动态发布时间
}
