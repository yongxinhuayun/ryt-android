 ...
 *
 */
public class Gallery03Activity extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		PublicWay03.activityList.add(this);
		mContext = this;
...
//		send_bt.setOnClickListener(new GallerySendListener());
		...
		for (int i = 0; i < Bimp03.tempSelectBitmap.size(); i++) {
			initListViews( Bimp03.tempSelectBitmap.get(i).getBitmap() );
		}
	...
	private class DelListener implements OnClickListener {
		...
		public void onClick(View v) {
			if (listViews.size() == 1) {
				Bimp03.tempSelectBitmap.clear();
				Bimp03.max = 0;
				tvImageCount.setText( Bimp03.tempSelectBitmap.size() + "/"+ PublicWay03.num);
				Intent intent = new Intent("data.broadcast.action");  
                sendBroadcast(intent);  
				finish();
			} else {
				Bimp03.tempSelectBitmap.remove(location);
				Bimp03.max--;
