...
public class CircleMovementMethod extends BaseMovementMethod {
    ...
    public CircleMovementMethod(){
        this.textViewBgColor = AppApplication.getSingleContext().getResources().getColor(DEFAULT_COLOR_ID);
        this.clickableSpanBgClor = AppApplication.getSingleContext().getResources().getColor(DEFAULT_CLICKABLEA_COLOR_ID);
    }
