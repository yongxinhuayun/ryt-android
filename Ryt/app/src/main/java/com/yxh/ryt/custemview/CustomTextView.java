...
public class CustomTextView extends TextView{
    ...
    public CustomTextView(Context context, AttributeSet attrs) {
        ...
        marginLeft = attrs.getAttributeIntValue(namespace, "marginLeft", 14);
        marginRight = attrs.getAttributeIntValue(namespace, "marginRight", 14);
    ...
    public CustomTextView(Context context, float textSize, int textColor, float paddingLeft, float paddingRight, float marginLeft, float marginRight){
        super(context);
