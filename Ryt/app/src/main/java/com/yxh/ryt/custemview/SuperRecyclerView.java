...
public class SuperRecyclerView extends FrameLayout {
    ...
    private void initView() {
        ...
        mPtrLayout = (SuperSwipeRefreshLayout) v.findViewById(R.id.ptr_layout);
    ...
    /**
     * Set the listener when refresh is triggered and enable the SuperSwipeRefreshLayout
     */
    public void setRefreshListener(SuperSwipeRefreshLayout.OnPullRefreshListener listener) {
        mPtrLayout.setEnabled(true);
        mPtrLayout.setOnPullRefreshListener(listener);
    }

    /**
     * Set the colors for the SuperSwipeRefreshLayout states
     */
