...
import com.yxh.ryt.util.utils.DensityUtil;
...
public class SnsPopupWindow extends PopupWindow implements OnClickListener{
	...
	public void showPopupWindow(View parent, ArtworkMessage artworkMessage){
	...
	public void onClick(View view) {
		...
		switch (view.getId()) {
		case R.id.digBtn:
			mItemClickListener.onItemClick(mActionItems.get(0), 0,artworkMessage);
			break;
		case R.id.commentBtn:
			mItemClickListener.onItemClick(mActionItems.get(1), 1, artworkMessage);
			break;
		default:
			break;
		}
	...
	public static interface OnItemClickListener {
		public void onItemClick(ActionItem item, int position, ArtworkMessage artworkMessage);
	}
}
