...
public class FansUserItemFragment extends BaseFragment implements AutoListView.OnRefreshListener,
	...
	public FansUserItemFragment(String userId, String otherUserId, String flag) {
		super();
		this.userId=userId;
