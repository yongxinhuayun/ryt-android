...
import com.yxh.ryt.activity.RecordVedioFullActivity;
import com.yxh.ryt.widgets.videolist.VideoListGlideModule;
import com.yxh.ryt.widgets.videolist.model.VideoLoadMvpView;
import com.yxh.ryt.widgets.videolist.target.VideoLoadTarget;
import com.yxh.ryt.widgets.videolist.target.VideoProgressTarget;
        ...
        videoPlayer.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                if (videoPlayer.isPlaying()) {
                    Intent intent = new Intent(getContext(), RecordVedioFullActivity.class);
                    Bundle bundle = new Bundle();
                    bundle.putString("text", videoUrl);
