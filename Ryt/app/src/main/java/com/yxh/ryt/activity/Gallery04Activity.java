...
public class Gallery04Activity extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		PublicWay04.activityList.add(this);
		mContext = this;
...
//		send_bt.setOnClickListener(new GallerySendListener());
		...
		for (int i = 0; i < Bimp04.tempSelectBitmap.size(); i++) {
			initListViews( Bimp04.tempSelectBitmap.get(i).getBitmap() );
		}
	...
	private class DelListener implements OnClickListener {
		...
		public void onClick(View v) {
			if (listViews.size() == 1) {
				...
				Bimp03.max = 0;
				tvImageCount.setText( Bimp04.tempSelectBitmap.size() + "/"+ PublicWay04.num);
